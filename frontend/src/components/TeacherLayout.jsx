...
import { HomeOutlined, BookOutlined, FormOutlined, LogoutOutlined } from '@ant-design/icons'
...
export default function TeacherLayout() {
  ...
  const name = localStorage.getItem('realName') || '老师'

  const menuItems = [
    { key: '/teacher', icon: <HomeOutlined />, label: '首页' },
    { key: '/teacher/courses', icon: <BookOutlined />, label: '我的授课' },
  ]
